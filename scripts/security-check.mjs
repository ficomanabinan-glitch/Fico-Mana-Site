...
if (!portalWorkflow.includes('assertStorageKeyOwnership(storageKey, String(portal.workspace_id), String(portal.booking_id))')) failures.push('Portal photo access must verify the exact workspace and booking storage key.')
