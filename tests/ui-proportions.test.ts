...
test('photo layout uses the requested desktop, tablet, and mobile hierarchy', () => {
  ...
  assert.match(selection, /sticky top-\[7rem\] z-20[^>]+md:top-3 xl:top-6/)
  ...
  assert.match(selection, /2xl:grid-cols-\[minmax\(0,1fr\)_minmax\(400px,480px\)\]/)
  assert.match(selection, /min-\[1920px\]:grid-cols-8/)
