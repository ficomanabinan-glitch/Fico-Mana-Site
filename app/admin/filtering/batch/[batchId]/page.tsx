...
function JobRow({job,busy,simple,canOnsite,canAdmin,onUploadRaw,onSyncRaw,onReconcile,onReopen}:{job:Job;busy:boolean;simple:boolean;canOnsite:boolean;canAdmin:boolean;onUploadRaw:(bookingId:string)=>void;onSyncRaw:(bookingId:string)=>Promise<void>;onReconcile:(bookingId:string,repair?:boolean)=>Promise<void>;onReopen:(bookingId:string)=>Promise<void>}){
