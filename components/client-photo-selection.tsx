...
export function ClientPhotoSelection({
  ...
  return <section className="w-full min-w-0 max-w-full rounded-card border border-white/10 bg-white/[0.02] p-3 sm:p-4 lg:p-5">
    <div className="grid min-w-0 gap-5 md:grid-cols-[minmax(0,1fr)_minmax(240px,300px)] md:items-start xl:grid-cols-[minmax(0,1fr)_minmax(270px,340px)] 2xl:grid-cols-[minmax(0,1fr)_minmax(400px,480px)]">
