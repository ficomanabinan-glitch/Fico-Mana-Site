...
export function mapDbBookingToModel(b: DbBookingRow): Booking {
  ...
  return {
    ...
    selectionLimit: b.selection_limit == null ? undefined : Number(b.selection_limit),
    ...
    discountLabel: b.discount_label ? String(b.discount_label) : undefined,
    transactionRef,
...
export function mapModelBookingToDbCore(b: Booking): Record<string, unknown> {
  ...
  return {
    ...
    selection_limit: b.selectionLimit ?? null,
    ...
    discount_label: b.discountLabel?.trim() || null,
